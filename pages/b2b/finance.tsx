...
export default function FinancePage() {
    ...
    return (
        <AdminLayout
            title="Finance"
            subtitle="Manage your transactions and payments"
        >
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
                        <div>
                            <p className="text-xs font-bold text-gray-500 mb-1">Total Transactions</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
                        <div>
                            <p className="text-xs font-bold text-gray-500 mb-1">Total Outstanding Amount</p>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex justify-between items-center">
                        <div>
                            <div className="flex gap-2 mb-2">
                                <span className="px-2 py-0.5 bg-gray-100 rounded text-[10px] font-bold text-gray-600">January</span>
                                <span className="px-2 py-0.5 bg-gray-100 rounded text-[10px] font-bold text-gray-600">2024</span>
                            </div>
                            <p className="text-xs text-gray-400 mb-0.5">Outstanding Per Month</p>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-4 mb-6">
                        <div className="flex-1 min-w-[200px] relative">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border-none rounded-lg text-sm focus:ring-2 focus:ring-[#FCD34D]"
                            />
                        </div>
                    ...
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-50">
                        <p className="text-xs text-gray-400">Showing 1 to 5 of 1,247 results</p>
                        <div className="flex gap-2">
                            <button className="w-8 h-8 rounded border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gray-50"><FaChevronLeft className="text-xs" /></button>
                            ...
                            <button className="w-8 h-8 rounded border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gray-50"><FaChevronRight className="text-xs" /></button>
                        </div>
                    </div>
                </div>
