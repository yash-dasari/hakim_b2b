...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let errorMessage = errorPayload?.message || 'An unexpected error occurred. Please try again.';
  ...
  return (
    <>
      <Head>
        <title>Login - HAKIM for Business</title>
        <meta name="description" content="Login to your HAKIM for Business account" />
      </Head>
      ...
      <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans text-gray-900">
        ...
        <div className="max-w-[480px] w-full bg-white rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-10 sm:p-12">
          ...
          <div className="text-center mb-10">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 font-medium tracking-wide">for Business</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="email"
                    type="email"
                    className={`block w-full pl-10 pr-3 py-3 border ${fieldErrors.email ? 'border-red-500' : 'border-gray-200'} rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FCD34D] focus:border-transparent transition-all sm:text-sm`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-10 py-3 border ${fieldErrors.password ? 'border-red-500' : 'border-gray-200'} rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FCD34D] focus:border-transparent transition-all sm:text-sm`}
            ...
            <div className="pt-2 space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-400 text-xs">Don't have an account?</span>
                </div>
              </div>
          ...
          <div className="mt-8 flex justify-center space-x-6 text-xs text-gray-400">
            ...
            <a href="#" className="hover:text-gray-500">Support</a>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400 font-medium">
            Secure business login powered by <span className="text-gray-700 font-bold">HAKIM</span>
          </p>
        </div>
